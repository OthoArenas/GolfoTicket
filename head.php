...
<ul id="slide-out" class="sidenav">
    <li>
        <div class="user-view">
            ...
            <div class="text-center justify-content-center">
                ...
                <a href="dashboard.php"><img class="circle ml-auto mr-auto hoverable" src="images/profiles/<?php echo $profile_pic; ?>" alt="<?php echo $name; ?>"></a>
                <span class="white-text">Bienvenid@,</span>
                <a href="#dashboard.php"><span class="white-text name"><?php echo $name . " " . $lastname; ?></span></a>
                <a href="dashboard.php"><span class="white-text email"><?php echo $email; ?></span></a>
            </div>
    ...
    <li><a href="https://dsignstudio.com.mx" target="_blank"> <img src="images/logo.png" alt="D-Sign Studio Logo" id="icon_logo_menu"> D-Sign Studio</a></li>
    <div class="divider"></div>
